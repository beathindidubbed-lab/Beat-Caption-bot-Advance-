...
# ----------------------------------------------------------------------
# FIX APPLIED: Replaced the non-existent 'app.process_raw_update' with 
# the correct 'await app.updates.put(update_dict)'
# ----------------------------------------------------------------------

async def telegram_webhook(request):
    """Handle incoming webhook updates from Telegram using Pyrogram's internal processing queue."""
    try:
        ...
        # This is the correct way to feed raw updates to the client's internal queue.
        await app.updates.put(update_dict) 
